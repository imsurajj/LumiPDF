...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* result{};
        consume_general<winrt::Windows::Devices::Printers::IIppAttributeConverterStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Printers::IIppAttributeConverterStatics>::ConvertPrintTicketToIppAttributesForPrinter, *(void**)(&printerName), *(void**)(&printTicket), &result);
    ...
    {
        std::int32_t __stdcall ConvertPrintTicketToIppAttributesForPrinter(void* printerName, void* printTicket, void** result) noexcept final try
        {
            clear_abi(result);
