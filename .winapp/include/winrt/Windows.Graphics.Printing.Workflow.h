...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        bool value{};
        consume_general<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowPrinterJob3, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowPrinterJob3>::get_IsPassthroughJob, &value);
        return value;
    }
    ...
    {
        std::int32_t __stdcall get_IsPassthroughJob(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
